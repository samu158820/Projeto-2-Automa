...
#define histerese 1.5 //erro aceitável entre setPoint e temperatura atual
...
void loop()
{
  ...
  if(StateAtual != manHeat && StateAtual != manFan)
  {
    if(HeatVal < (setPoint - histerese))
    {
      ...
      heaton = 1;
      fanon = 0;
    }else if(HeatVal > (setPoint + histerese))
    {
